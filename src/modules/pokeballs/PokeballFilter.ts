...
export default class PokeballFilter {
    ...
    get options(): { [K in keyof PokeballFilterOptions]: Setting<PokeballFilterOptions[K]> } {
        return this._options() as { [K in keyof PokeballFilterOptions]: Setting<PokeballFilterOptions[K]> };
    }

    set options(value: { [K in keyof PokeballFilterOptions]: Setting<PokeballFilterOptions[K]> }) {
        this._options(value);
    }
